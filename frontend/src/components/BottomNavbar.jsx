...
function BottomNavbar() {
  return (
    <nav className=" bottom-0 left-0 right-0 w-full bg-slate-800 shadow-lg flex justify-around px-4 py-4 md:px-6 md:py-4">
      ...
      <Link className="flex flex-col items-center gap-1 text-slate-400 hover:text-gray-200 transition-colors" to="/add">
        <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 20 20">
          <path fillRule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clipRule="evenodd" />
        </svg>
        <div className="text-xs md:text-sm font-medium">Add Vehicle</div>
      </Link>
      <Link className="flex flex-col items-center gap-1 text-slate-400 hover:text-gray-200 transition-colors" to="/display">
        <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 20 20">
      ...
      <Link className="flex flex-col items-center gap-1 text-slate-400 hover:text-gray-200 transition-colors" to="/update">
        <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 20 20">
          <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
        </svg>
        <div className="text-xs md:text-sm font-medium">Update</div>
      </Link>
      <Link className="flex flex-col items-center gap-1 text-slate-400 hover:text-gray-200 transition-colors" to="/admin">
        <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 20 20">
