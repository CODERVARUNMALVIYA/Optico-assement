...
function TopNavbar() {
  return (
    <div>
        ...
        <div className="text-sm text-amber-500 font-medium mt-24">()</div>
        <div className="flex flex-col items-center flex-1">
          <div className="font-bold text-xl md:text-2xl lg:text-3xl text-center">Vehicle Validator</div>
          <div className="text-base md:text-lg lg:text-3xl text-amber-500 font-bold mt-1 text-center">Ganpati Infinity Society</div>
        </div>
